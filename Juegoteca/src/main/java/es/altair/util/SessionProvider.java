...
public class SessionProvider {
	...
	static {
		configuration = new Configuration()
				...
				.setProperty("hibernate.connection.url", "jdbc:mysql://localhost/bdjuegoteca")
				.setProperty("hibernate.connection.username", "root")
				.setProperty("hibernate.connection.password", "altair")
				.setProperty("hibernate.show_sql", "true")
				.addAnnotatedClass(es.altair.bean.Usuario.class)
				.addAnnotatedClass(es.altair.bean.Juego.class)
				.addAnnotatedClass(es.altair.bean.Genero.class)
				.addAnnotatedClass(es.altair.bean.Juegoteca.class);
